...
exports.PageShowContent = void 0;
const argument = process.argv.slice(2);
const Tag = argument[0].charAt(0).toUpperCase() + argument[0].slice(1);
const PageShowContent = (pageName, resource, method, fields) => {
  ...
  return (
    <Show isLoading={isLoading}>
      <Stack gap={1}>
         ...
         ${keys.map((item, index) => '<div>          <Typography variant="body1" fontWeight="bold">\n          ' +
        item +
...
exports.PageShowContent = PageShowContent;
